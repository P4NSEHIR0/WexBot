...
exports.execute = async (client, message, args) => {
  ...
  return message.react(client.emojis.cache.find(x => x.name === "wex_carpi"));
    ...
    ${await db.has(`jailbilgi_wex`) ? `[**${acik}**] **Jail Bilgi** (<#${await db.get(`genelchat_wex`)}>)` : `[**${kapali}**] \`.kanalsetup jailbilgi #kanal\`[**Jail-Bilgi**]`}
    ${await db.has(`banbilgi_wex`) ? `[**${acik}**] **Ban Bilgi** (<#${await db.get(`genelchat_wex`)}>)` : `[**${kapali}**] \`.kanalsetup banbilgi #kanal\`[**Ban-Bilgi**]`}
    ${await db.has(`cpuanbilgi_wex`) ? `[**${acik}**] **Cezapuan Chat** (<#${await db.get(`genelchat_wex`)}>)` : `[**${kapali}**] \`.kanalsetup cezapuanbilgi #kanal\`[**Cezapuan-Bilgi**]`}
