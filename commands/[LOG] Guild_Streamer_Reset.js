...
var wexgönder = '832706208574078981'
const wexembed = new Discord.MessageEmbed().setFooter(`Sıfırlanmadan önce açılan yayın sayısı: ${toplamyayın} `).setColor("BLUE").setDescription(`sunucunun yayın açma geçmişi ${message.author} tarafından sıfırlandı.`)
client.channels.cache.get(wexgönder).send(wexembed);
