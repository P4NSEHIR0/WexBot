...
exports.execute = async (client, message, args) => {
    ...
    if (message.member.roles.highest.position <= user.roles.highest.position) return message.react(client.emojis.cache.find(x => x.name === "wex_carpi"));
...
exports.conf = {
  ...
  aliases: ["wexban","berkayban","wexincekici", "berkayıncekici"] // Komutumuzun yardımcıları
}